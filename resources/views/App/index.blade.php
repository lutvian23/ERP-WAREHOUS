  ...
  <body class="bg-body-secondary">
    ...
    <div class="d-flex" style="width: 100vw; height: 100vh;">
      <header class="bg-dark text-light p-2" style="height: 100%; width:15%">
        ...
        <div style="height:90%">
          <div class="d-flex flex-column gap-2" id="group-link">
            ...
            <a id="link-sidebar" onclick="pageLink('{{url('/truck')}}')" class="text-decoration-none" href="#">TRUCK</a>
      ...
      <div style="height: 100%; width: 85%">
        <div id="alert_success" class="position-absolute"></div>
        <div id="content" class="p-2" style="heigth: 100%; width: 100%">
